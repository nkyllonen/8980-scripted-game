...
```
[video link](https://drive.google.com/file/d/19XKEfIdugdSn76YNc4uFzIYXYOcTjahH/view?usp=sharing)
...
<img src="https://github.com/nkyllonen/8980-large-scenes/blob/master/images/simple-scene.png" width="100%"/>

This is a sample scene containing a simple trex model, a teapot model, and a small, tiled floor. Run as such: ./engine SimpleExample/

- 1b

This is a scene containing the same teapot model from above and an oak tree model which we downloaded from TurboSquid. See the resources section for a link to download the package.

- 1c
[Dynamic camera link](https://drive.google.com/file/d/1ZdrrtIgAiWb35ReJ9b_xjar0VDjuLQ5L/view?usp=sharing)
This video showcases our dynamic camera. By using the left/right arrow keys, you are able to rotate the camera to the left/right respectively. By using the up/down arrow keys, you are able to move the camera forward/backward respectively.
1d

Describe what approaches you took to accelerating your slow scene from 1d. Include images documenting changes in visual quality with and without your acceleration code.
